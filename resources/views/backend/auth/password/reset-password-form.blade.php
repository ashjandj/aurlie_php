                                ...
                                <div class="card-inner card-inner-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des ">
                                                <p>{{ __('labels.enter_newpassword_below') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <form action="{{ route('admin.password.post') }}" id="add-form" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <input type="password" class="form-control form-control-lg" name="password"
                                                    id="password" placeholder="{{ __('labels.new_password') }}" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-label-group">
                                                <label class="form-label"
                                                    for="confirm-password">{{ __('labels.confirm_new_password') }}</label>
                                            </div>
                                            <div class="form-control-wrap">
                                        ...
                                        <div class="form-group mb-0">
                                            <button type="submit"
                                                class="btn btn-lg btn-primary btn-block">{{ __('labels.update') }}</button>
                                        </div>
                                        {!! JsValidator::formRequest('App\Http\Requests\Backend\ResetPasswordRequest', '#add-form') !!}
                                    </form>
                                </div>
                            </div>
                        </div>
